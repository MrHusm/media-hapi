...
<#if error?? >
    ...
    <div class="w_books ebook_pop">
        <div class="w_books_cont">
            ...
            <div class="content">
                <h4>${errorDes}</h4>
                <p>点击查看：<a href="javascript:void(0)"
                           onclick="window.parent.EBOOKCART.closeWin('onekey');window.open('http://my.dangdang.com/myhome/homepage.aspx')">我的当当 </a>
                    &gt;<a href="javascript:void(0)"
                           onclick="window.parent.EBOOKCART.closeWin('onekey');window.open('http://e.dangdang.com/ebook/listUserEbooks.do')">数字商品</a>
                </p>
            </div>
        </div>
    </div>
